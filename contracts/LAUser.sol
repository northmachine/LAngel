...
contract LAUser{
    ...
    struct userMsg{
	    ...
	    uint8 rate;
	    string absolutePath;
	    string transDataHash;
        TransData[] transData;
    }

    function getTransDataHash(string userName) public returns(string){
        return User[userName].transDataHash;
    }

    function setTransDataHash(string userName,string hash) public {
        User[userName].transDataHash = hash;
    }
...
contract TransData{
    ...
    function getData() public returns(bool,string,uint,bool,uint){
