...
contract LACoin  is owned {
    ...
    function LACoin(uint initialSupply, uint8 _decimals,address server) payable{
    ...
    function getUserBalance(address add) public  returns(uint){
	...
	//发行代币，向指定的目标账户添加代币
    function sendCoin(address target,uint mintedAmount) onlyOwner{
